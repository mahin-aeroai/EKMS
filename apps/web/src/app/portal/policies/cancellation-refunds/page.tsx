...
export default function CancellationRefundsPage() {
  return (
    <article>
      <h1 className="text-xl font-semibold text-ink">Cancellation &amp; Refunds</h1>
      ...
      <h2 className="mt-6 text-sm font-semibold text-ink">Cancelling an order</h2>
      ...
      <h2 className="mt-6 text-sm font-semibold text-ink">Refunds</h2>
      <ul className="mt-2 list-disc space-y-1 pl-5 text-sm leading-relaxed text-ink-secondary">
      ...
      <h2 className="mt-6 text-sm font-semibold text-ink">What isn&apos;t covered</h2>
