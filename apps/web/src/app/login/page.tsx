...
function LoginForm() {
  ...
  // token in the hash is perfectly valid (caught via the identical bug on
  // the portal's own login page). Parse it ourselves and call setSession()
  // explicitly as a fallback; this is a no-op (same tokens) on top of a
  // session the client already auto-established, so it's safe either way.
  useEffect(() => {
