...
import { Download, UploadCloud, CheckCircle2, RotateCcw, CreditCard, Truck, Radar, FileText, Eye, ExternalLink, X, MapPin } from "lucide-react";
...
// Same tracking-stepper card LFG Connect's own ShipmentCard now uses
                ...
                <div key={s.id} className="rounded-lg border border-line p-4">
                  ...
                  <div className="mt-4">
                    <ShipmentTrackingStepper
                      ...
                      statusLabel={shipmentStatusLabel(s.current_status)}
                      exceptionLocation={s.current_location}
                    />
                  </div>
