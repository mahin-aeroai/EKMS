// packages/shared/src/sign-estimator/calc.ts
//
...
//
// Zero imports, deliberately -- this file is shared with the Expo app and
// must run under Hermes.

// ── Master data shapes (structurally compatible with the Supabase row types
//    in packages/shared/src/rows.ts -- kept separate so this file has zero
